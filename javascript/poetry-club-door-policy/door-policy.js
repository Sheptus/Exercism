...
export function backDoorResponse(blurb) {
  let trimedWord = blurb.trim()
  let lastLetter = trimedWord.charAt(trimedWord.length-1)
...
function capitalize(word) {
  let capitalized = frontDoorResponse(word).toUpperCase() + word.slice(1).toLowerCase()
